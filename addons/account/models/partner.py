...
class ResPartner(models.Model):
    ...
    property_outbound_payment_method_line_id = fields.Many2one(
        ...
        check_company=True,
        company_dependent=True,
        domain=lambda self: [('journal_id.active', '=', True), ('payment_type', '=', 'outbound'), ('company_id', 'parent_of', str(self.env.company.id))],
    )
    ...
    property_inbound_payment_method_line_id = fields.Many2one(
        ...
        check_company=True,
        company_dependent=True,
        domain=lambda self: [('journal_id.active', '=', True), ('payment_type', '=', 'inbound'), ('company_id', 'parent_of', str(self.env.company.id))],
    )
