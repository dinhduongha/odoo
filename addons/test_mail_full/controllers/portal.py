...
class PortalTest(http.Controller):
    ...
    @http.route('/my/test_portal/<string:res_id>', type='http', auth='public', methods=['GET'])
    ...
    @http.route("/my/test_portal_records/<string:res_id>", type="http", auth="public", website=True)
    ...
    @http.route("/my/test_portal_rating_records/<string:res_id>", type="http", auth="public", website=True)
    ...
    @http.route('/test_portal/public_type/<string:res_id>', type='http', auth='public', methods=['GET'])
