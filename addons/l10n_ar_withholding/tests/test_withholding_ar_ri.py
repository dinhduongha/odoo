...
class TestArWithholdingArRi(TestArCommon):
    ...
    def setUpClass(cls):
        ...
        cls.tax_wth_test_1 = cls.env.ref('account.%s_ex_tax_withholding_iibb_caba_applied' % cls.env.company.id)
        ...
        cls.tax_wth_test_2 = cls.env.ref('account.%s_ex_tax_withholding_iibb_ba_applied' % cls.env.company.id)
        ...
        cls.tax_wth_earnings_incurred_scale_test_5 = cls.env.ref('account.%s_ex_tax_withholding_profits_regimen_110_insc' % cls.env.company.id)
        cls.tax_wth_earnings_incurred_test_6 = cls.env.ref('account.%s_ex_tax_withholding_profits_regimen_35_insc' % cls.env.company.id)
