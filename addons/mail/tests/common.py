    ...
    def assertTracking(self, message, data, strict=False):
        ...
        for field_name, value_type, old_value, new_value in data:
            ...
            if value_type == 'many2one':
                self.assertEqual(tracking.old_value_uuid or False, old_value and old_value.id or False)
                self.assertEqual(tracking.new_value_uuid or False, new_value and new_value.id or False)
