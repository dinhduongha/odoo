...
class TestUiSEPA(TestPosQrCommon):
    ...
    def test_01_pos_order_with_sepa_qr_payment_fail(self):
        ...
        self.start_tour("/pos/ui/%s" % self.main_pos_config.id, 'PaymentScreenWithQRPaymentFailure', login="pos_user")
    ...
    def test_02_pos_order_with_sepa_qr_payment(self):
        ...
        self.start_tour("/pos/ui/%s" % self.main_pos_config.id, 'PaymentScreenWithQRPayment', login="pos_user")
...
class TestUiCH(TestPosQrCommon):
    ...
    def test_02_pos_order_with_swiss_qr_payment(self):
        ...
        self.start_tour("/pos/ui/%s" % self.main_pos_config.id, 'PaymentScreenWithQRPaymentSwiss', login="pos_user")
